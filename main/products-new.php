...
if(isset($_POST['name'])){
    ...
    products_new($filename , $_POST['name'] , $_POST['paragraph']);
    ...
    <div class="form">
      <div class="container">
            <div class="form-new">
                ...
                <form method="POST" action="products-new.php" enctype="multipart/form-data">
                    
                    <input type="file" placeholder="Product Name" name="image">
                    <input type="text" placeholder="Product Name" name="name" required>
                    <input type="text" placeholder="Product INFO." name="paragraph">
