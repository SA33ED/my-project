...
if(isset($_POST["name"])){
    products_update($_POST["id"],$_POST["name"],$_POST["paragraph"],$_FILES["image"]);
} 

$data=products_edit($_GET["id"]);
?>
    ...
    <div class="form">
      <div class="container">
            <div class="form-new">
                ...
                <form method="POST" action="products-edit.php" enctype="multipart/form-data">
                    <img src="../img/<?php echo $data["image"] ?>" alt="">

                    <input type="file" name="image">
                    <input type="hidden" value="<?php echo $data["id"] ?>" name="id">
                    <input type="text" value="<?php echo $data["name"] ?>" name="name" required>
                    <input type="text" value="<?php echo $data["paragraph"] ?>" name="paragraph">
